...
public class GetCustomer {
    ...
    public CustomerResponse addNewCustomer(@RequestBody CustomerRequest request){
        ...
        customer.setCustomerId(getRandomID(5));
        ...
        customerAddress.setAddressId(customer.getAddressId());
        customerAddress.setHouseNumber(request.getHouseNumber());
        customerAddress.setAddressLine1(request.getAddressLine1());
        customerAddress.setAddressLine2(request.getAddressLine2());
        customerAddress.setCity(request.getCity());
        customerAddress.setCustomerByCustomerId(customer);

        ContactNumber contactNumber = new ContactNumber();
        contactNumber.setPhoneId(customer.getContactNumber());
        contactNumber.setCustomerByCustomerId(customer);
        contactNumber.setCountryCode(Integer.parseInt(request.getContactCountryCode()));
        contactNumber.setPhoneNumber(Long.parseLong(request.getContactNumber()));
